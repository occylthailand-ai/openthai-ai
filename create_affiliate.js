...
let hubHtml = `<!-- OpenThaiAi - Global Affiliate Hub -->
...
<h1>🤖 OpenThaiAi — Affiliate Hub</h1>
...
affiliates.forEach((a, idx) => {
  ...
  const pageHtml = `<!-- OpenThaiAi - ${a.name} Affiliate -->
...
<p style="color:#fff;margin:0;font-size:1.1rem;">🤖 OpenThaiAi ช่วยสร้าง Content Affiliate ทุกภาษา ทุกแพลตฟอร์ม</p>
...
<h2 style="color:#fff;margin:0;">🤖 OpenThaiAi Affiliate Hub</h2>
