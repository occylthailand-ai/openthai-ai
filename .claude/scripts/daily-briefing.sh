...
📚 Skills Registry      ✅ /api/skills (catalog · 30 skills)
...
/skills        AISkillsPage     (auth) ← S9–S30 · data-driven tabs
/skills-catalog SkillsCatalogPage (auth) ← catalog 30 skills (live registry)
