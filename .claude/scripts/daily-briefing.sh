...
📚 Skills Registry      ✅ /api/skills (catalog · 33 skills)
...
/skills        AISkillsPage     (auth) ← S9–S33 · data-driven tabs
/skills-catalog SkillsCatalogPage (auth) ← catalog 33 skills (live registry)
