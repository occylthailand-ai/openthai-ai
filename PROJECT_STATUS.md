...
Generated: 2026-08-05T09:07:41.931Z · branch `claude/stage-s3-concurrency-reconcile-3bw18v` (1 commit(s) ahead of main)

> Paste this whole file at the start of a Claude / Gemini / Grok conversation about this project
> so all three start from the same facts, pulled directly from the repo — not from memory.

## What this project actually is (read this before anything else)
- Git history: 220 commits, earliest 2026-04-02 — this is the entire real history, there is no earlier "locked" architecture beyond what's in this repo.
...
## Recent commits
- 47ba70e feat(etax): S1 mTLS test, S2 XAdES-T submit, S3 concurrent batch + reconciler (50 seconds ago)
- e37f988 feat(enterprise): request-ID tracing, structured logging, error handler, audit trail (#90) (5 days ago)
- 6657b77 feat: structured logger, migration tracker, auth tests (#89) (5 days ago)
- 88926ec feat(claude): OpenHands microagents + scaffold tool + improved checks (#88) (5 days ago)
- 352f694 feat(claude): OpenHands-style microagents + tool scripts (#87) (5 days ago)
- a545554 feat(responsive): dashboard bottom tab bar + responsive grids for all screen sizes (#85) (6 days ago)
- b0379f2 feat(dashboard): add 🔄 จับคู่ tab with live matching widget (6 days ago)
- d558a41 Add B2B2C, C2B, G2G, G2B matching types (#83) (6 days ago)
