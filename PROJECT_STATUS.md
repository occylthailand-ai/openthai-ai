...
Generated: 2026-09-16T06:03:50.285Z · branch `copilot/create-learning-tool-for-openthaiai` (0 commit(s) ahead of main)
...
- ✅ **Skill endpoints resolve to real routes** — all 41 skill endpoints found in backend source
...
## Recent commits
- 67277a1 feat: add department tool builder registry (2 minutes ago)
- 392c8db feat(blueprint): Content Blueprint — เครื่องมือพัฒนาต่อยอดจากโครงสร้างเนื้อหา 8 หมวด (#94) (9 days ago)
- 61475aa feat: หมวด 2-6, 10, 12 — โค้ดครบ 7 หมวดที่ขาด (4 weeks ago)
- e37f988 feat(enterprise): request-ID tracing, structured logging, error handler, audit trail (#90) (7 weeks ago)
- 6657b77 feat: structured logger, migration tracker, auth tests (#89) (7 weeks ago)
- 88926ec feat(claude): OpenHands microagents + scaffold tool + improved checks (#88) (7 weeks ago)
- 352f694 feat(claude): OpenHands-style microagents + tool scripts (#87) (7 weeks ago)
- a545554 feat(responsive): dashboard bottom tab bar + responsive grids for all screen sizes (#85) (7 weeks ago)

## Production health (⚠️ unreachable from this environment (fetch failed))

## Skills registry (41 total, 39 active, 2 need setup)
...
| S36 | Content Blueprint | `GET /api/blueprint` | active |
...
| S39 | Department Tool Registry | `GET /api/department-tools` | active |
| S40 | Department Tool Brief | `POST /api/department-tools/develop` | active |
| S41 | Department Tool Batch Builder | `POST /api/department-tools/develop-all` | active |
...
| /corporate/tools | DepartmentToolsPage | auth |
...
| `department-tool-builder.js` | 266 | — |
...
| `server.js` | 7995 | Vercel serverless detection |
