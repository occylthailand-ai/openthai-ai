...
Generated: 2026-09-20T10:09:45.367Z · branch `claude/digital-yuan-openthaiai-compare-qt5dhn` (13 commit(s) ahead of main)

> Paste this whole file at the start of a Claude / Gemini / Grok conversation about this project
> so all three start from the same facts, pulled directly from the repo — not from memory.

## What this project actually is (read this before anything else)
- Git history: 96 commits, earliest 2026-06-23 — this is the entire real history, there is no earlier "locked" architecture beyond what's in this repo.
...
## Recent commits
- 5ec1014 chore: regenerate PROJECT_STATUS.md (3 minutes ago)
- ceb9733 chore: sync PROJECT_STATUS.md [skip ci] (3 minutes ago)
- 3778596 fix(digital-bank): lazy-init Supabase + Anthropic clients to fix CI smoke test (3 minutes ago)
- 5383e8e chore: sync PROJECT_STATUS.md [skip ci] (7 minutes ago)
- ae73fe4 chore: regenerate PROJECT_STATUS.md (8 minutes ago)
- 11bccc0 chore: sync PROJECT_STATUS.md [skip ci] (8 minutes ago)
- d4c2468 fix: add @supabase/supabase-js to backend dependencies (9 minutes ago)
- d68ceb0 chore: sync PROJECT_STATUS.md [skip ci] (12 minutes ago)
