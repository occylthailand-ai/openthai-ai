...
Generated: 2026-09-25T03:40:24.117Z · branch `claude/digital-yuan-openthaiai-compare-qt5dhn` (130 commit(s) ahead of main)

> Paste this whole file at the start of a Claude / Gemini / Grok conversation about this project
> so all three start from the same facts, pulled directly from the repo — not from memory.

## What this project actually is (read this before anything else)
- Git history: 362 commits, earliest 2026-04-02 — this is the entire real history, there is no earlier "locked" architecture beyond what's in this repo.
...
## Recent commits
- b9da022 chore: sync PROJECT_STATUS.md [skip ci] · Cycle 53 (3 minutes ago)
- 848c484 chore: sync PROJECT_STATUS.md [skip ci] · Cycle 52 stop-hook (13 minutes ago)
- 299a7c7 chore: sync PROJECT_STATUS.md [skip ci] · Cycle 52 final (22 minutes ago)
- a82650c chore: sync PROJECT_STATUS.md [skip ci] (34 minutes ago)
