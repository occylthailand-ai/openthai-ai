...
Generated: 2026-07-30T09:16:55.852Z · branch `claude/daily-reporter-improvements-8vc9ct` (559 commit(s) ahead of main)

> Paste this whole file at the start of a Claude / Gemini / Grok conversation about this project
> so all three start from the same facts, pulled directly from the repo — not from memory.

## What this project actually is (read this before anything else)
- Git history: 769 commits, earliest 2026-04-02 — this is the entire real history, there is no earlier "locked" architecture beyond what's in this repo.
...
## Recent commits
- 5ddd9a9 fix(ai): harden parseAIJson (null-safe + code-fence aware) — the parser 36 skills depend on (27 seconds ago)
- 9f75afd chore: sync PROJECT_STATUS.md [skip ci] (63 minutes ago)
