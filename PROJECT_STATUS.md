...
Generated: 2026-07-17T04:13:38.533Z · branch `claude/daily-reporter-improvements-8vc9ct` (398 commit(s) ahead of main)

> Paste this whole file at the start of a Claude / Gemini / Grok conversation about this project
> so all three start from the same facts, pulled directly from the repo — not from memory.

## What this project actually is (read this before anything else)
- Git history: 481 commits, earliest 2026-06-22 — this is the entire real history, there is no earlier "locked" architecture beyond what's in this repo.
...
- 8c7d9da test(portals): guard that every /portals/* lead type has a welcome email (no silent dead-end) (59 minutes ago)
...
- d7f9ef8 docs(decisions): log cross-repo smart-e fix (top-products excludes cancelled orders) (3 hours ago)
