...
Generated: 2026-07-04T06:11:56.973Z · branch `claude/daily-reporter-improvements-8vc9ct` (33 commit(s) ahead of main)

> Paste this whole file at the start of a Claude / Gemini / Grok conversation about this project
> so all three start from the same facts, pulled directly from the repo — not from memory.

## What this project actually is (read this before anything else)
- Git history: 243 commits, earliest 2026-04-02 — this is the entire real history, there is no earlier "locked" architecture beyond what's in this repo.
...
## Recent commits
- 362db7c Fix silent data exfiltration via /api/webhooks -- gate all 4 routes with admin key (17 seconds ago)
- 9c2b904 chore: sync PROJECT_STATUS.md [skip ci] (5 minutes ago)
- af3804a Rate-limit payment cancel/entitlement; flag the real fix as an owner decision (6 minutes ago)
- 23a48e3 chore: sync PROJECT_STATUS.md [skip ci] (3 hours ago)
- 7f8bb16 Fix a real vuln: PDPA erasure endpoint let anyone delete anyone else's data (3 hours ago)
- dd28985 chore: sync PROJECT_STATUS.md [skip ci] (4 hours ago)
- b967ec2 Rate-limit the 2 unsubscribe routes added in runs 9-10 (4 hours ago)
- 335f0df chore: sync PROJECT_STATUS.md [skip ci] (5 hours ago)
...
| `server.js` | 8203 | Vercel serverless detection |
