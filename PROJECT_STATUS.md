...
Generated: 2026-07-30T12:22:22.648Z · branch `claude/daily-reporter-improvements-8vc9ct` (560 commit(s) ahead of main)

> Paste this whole file at the start of a Claude / Gemini / Grok conversation about this project
> so all three start from the same facts, pulled directly from the repo — not from memory.

## What this project actually is (read this before anything else)
- Git history: 643 commits, earliest 2026-06-22 — this is the entire real history, there is no earlier "locked" architecture beyond what's in this repo.
...
- ccbc7af test(payment): cover verifyOmiseWebhook fail-closed guard (forged-webhook money hole) (7 hours ago)
