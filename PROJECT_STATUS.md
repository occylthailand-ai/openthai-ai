...
Generated: 2026-07-05T04:12:21.224Z · branch `claude/daily-reporter-improvements-8vc9ct` (71 commit(s) ahead of main)

> Paste this whole file at the start of a Claude / Gemini / Grok conversation about this project
> so all three start from the same facts, pulled directly from the repo — not from memory.

## What this project actually is (read this before anything else)
- Git history: 281 commits, earliest 2026-04-02 — this is the entire real history, there is no earlier "locked" architecture beyond what's in this repo.
...
## Recent commits
- a46ac82 fix: og-image.png didn't exist -- every social link preview has been broken since day one (17 seconds ago)
- 7240ed3 chore: sync PROJECT_STATUS.md [skip ci] (61 minutes ago)
- df3945a fix: exclude /producers/manage from search-engine crawling (62 minutes ago)
