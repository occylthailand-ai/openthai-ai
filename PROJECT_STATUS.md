...
Generated: 2026-07-04T07:09:32.356Z · branch `claude/daily-reporter-improvements-8vc9ct` (34 commit(s) ahead of main)

> Paste this whole file at the start of a Claude / Gemini / Grok conversation about this project
> so all three start from the same facts, pulled directly from the repo — not from memory.

## What this project actually is (read this before anything else)
- Git history: 117 commits, earliest 2026-06-22 — this is the entire real history, there is no earlier "locked" architecture beyond what's in this repo.
...
- af3804a Rate-limit payment cancel/entitlement; flag the real fix as an owner decision (63 minutes ago)
...
- b967ec2 Rate-limit the 2 unsubscribe routes added in runs 9-10 (5 hours ago)
