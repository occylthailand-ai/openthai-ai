...
Generated: 2026-09-20T10:11:07.174Z · branch `claude/digital-yuan-openthaiai-compare-qt5dhn` (15 commit(s) ahead of main)

> Paste this whole file at the start of a Claude / Gemini / Grok conversation about this project
> so all three start from the same facts, pulled directly from the repo — not from memory.

## What this project actually is (read this before anything else)
- Git history: 236 commits, earliest 2026-04-02 — this is the entire real history, there is no earlier "locked" architecture beyond what's in this repo.
...
## Recent commits
- 44aae96 chore: regenerate PROJECT_STATUS.md (22 seconds ago)
- 08ea943 chore: sync PROJECT_STATUS.md [skip ci] (4 minutes ago)
- 5ec1014 chore: regenerate PROJECT_STATUS.md (4 minutes ago)
- ceb9733 chore: sync PROJECT_STATUS.md [skip ci] (4 minutes ago)
- 3778596 fix(digital-bank): lazy-init Supabase + Anthropic clients to fix CI smoke test (5 minutes ago)
- 5383e8e chore: sync PROJECT_STATUS.md [skip ci] (9 minutes ago)
- ae73fe4 chore: regenerate PROJECT_STATUS.md (9 minutes ago)
- 11bccc0 chore: sync PROJECT_STATUS.md [skip ci] (10 minutes ago)
