...
Generated: 2026-09-14T13:21:57.446Z · branch `occylthailand-ai-continuous-development-engine` (0 commit(s) ahead of main)
...
## Recent commits
- 392c8db feat(blueprint): Content Blueprint — เครื่องมือพัฒนาต่อยอดจากโครงสร้างเนื้อหา 8 หมวด (#94) (7 days ago)
- 61475aa feat: หมวด 2-6, 10, 12 — โค้ดครบ 7 หมวดที่ขาด (4 weeks ago)
- e37f988 feat(enterprise): request-ID tracing, structured logging, error handler, audit trail (#90) (6 weeks ago)
- 6657b77 feat: structured logger, migration tracker, auth tests (#89) (6 weeks ago)
- 88926ec feat(claude): OpenHands microagents + scaffold tool + improved checks (#88) (6 weeks ago)
- 352f694 feat(claude): OpenHands-style microagents + tool scripts (#87) (6 weeks ago)
