...
Generated: 2026-09-20T10:39:07.814Z · branch `HEAD` (18 commit(s) ahead of main)

> Paste this whole file at the start of a Claude / Gemini / Grok conversation about this project
> so all three start from the same facts, pulled directly from the repo — not from memory.

## What this project actually is (read this before anything else)
- Git history: 101 commits, earliest 2026-06-23 — this is the entire real history, there is no earlier "locked" architecture beyond what's in this repo.
...
- 44aae96 chore: regenerate PROJECT_STATUS.md (28 minutes ago)
- 08ea943 chore: sync PROJECT_STATUS.md [skip ci] (32 minutes ago)
- 5ec1014 chore: regenerate PROJECT_STATUS.md (32 minutes ago)
- ceb9733 chore: sync PROJECT_STATUS.md [skip ci] (32 minutes ago)
- 3778596 fix(digital-bank): lazy-init Supabase + Anthropic clients to fix CI smoke test (33 minutes ago)
