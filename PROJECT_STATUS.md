...
Generated: 2026-07-17T23:14:00.735Z · branch `claude/daily-reporter-improvements-8vc9ct` (423 commit(s) ahead of main)

> Paste this whole file at the start of a Claude / Gemini / Grok conversation about this project
> so all three start from the same facts, pulled directly from the repo — not from memory.

## What this project actually is (read this before anything else)
- Git history: 633 commits, earliest 2026-04-02 — this is the entire real history, there is no earlier "locked" architecture beyond what's in this repo.
...
## Recent commits
- 32ccd32 feat(quickpay): email a receipt to the buyer when a QuickPay charge is paid (21 seconds ago)
- 3b693ac chore: sync PROJECT_STATUS.md [skip ci] (62 minutes ago)
