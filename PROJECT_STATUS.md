...
Generated: 2026-09-20T10:39:29.615Z · branch `claude/digital-yuan-openthaiai-compare-qt5dhn` (19 commit(s) ahead of main)

> Paste this whole file at the start of a Claude / Gemini / Grok conversation about this project
> so all three start from the same facts, pulled directly from the repo — not from memory.

## What this project actually is (read this before anything else)
- Git history: 240 commits, earliest 2026-04-02 — this is the entire real history, there is no earlier "locked" architecture beyond what's in this repo.
...
## Recent commits
- b9ecfc1 chore: regenerate PROJECT_STATUS.md (29 seconds ago)
- d2a11d8 chore: sync PROJECT_STATUS.md [skip ci] (4 minutes ago)
- 281ba82 feat(bank): Phase 2 — สินเชื่อ ประกัน ลงทุน ชำระบิล Trade Finance เงินเดือน (5 minutes ago)
- adc468f chore: sync PROJECT_STATUS.md [skip ci] (28 minutes ago)
- 44aae96 chore: regenerate PROJECT_STATUS.md (29 minutes ago)
- 08ea943 chore: sync PROJECT_STATUS.md [skip ci] (32 minutes ago)
- 5ec1014 chore: regenerate PROJECT_STATUS.md (33 minutes ago)
- ceb9733 chore: sync PROJECT_STATUS.md [skip ci] (33 minutes ago)
