...
Generated: 2026-07-02T04:23:35.855Z · branch `claude/ai-coalition-protocol-hp3rga` (20 commit(s) ahead of main)

> Paste this whole file at the start of a Claude / Gemini / Grok conversation about this project
> so all three start from the same facts, pulled directly from the repo — not from memory.

## What this project actually is (read this before anything else)
- Git history: 70 commits, earliest 2026-06-16 — this is the entire real history, there is no earlier "locked" architecture beyond what's in this repo.
...
## Recent commits
- b23a892 Add real human-in-the-loop review for AI-generated content (7 seconds ago)
- 7f91ca1 chore: sync PROJECT_STATUS.md [skip ci] (8 minutes ago)
- 310b903 chore: regenerate PROJECT_STATUS.md after rebase (8 minutes ago)
- 1f6b4d7 Log rejected claim: OpenThaiAi described as a foundation-model/tokenizer project (8 minutes ago)
- 75c6ce8 chore: sync PROJECT_STATUS.md [skip ci] (43 minutes ago)
- c416a14 chore: regenerate PROJECT_STATUS.md after rebase (43 minutes ago)
- 57b337f Fix: all 7 /portals/* pages were silently failing to submit (43 minutes ago)
- 6447e34 chore: sync PROJECT_STATUS.md [skip ci] (62 minutes ago)
