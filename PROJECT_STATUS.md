...
Generated: 2026-07-03T23:12:30.156Z · branch `HEAD` (20 commit(s) ahead of main)

> Paste this whole file at the start of a Claude / Gemini / Grok conversation about this project
> so all three start from the same facts, pulled directly from the repo — not from memory.

## What this project actually is (read this before anything else)
- Git history: 103 commits, earliest 2026-06-22 — this is the entire real history, there is no earlier "locked" architecture beyond what's in this repo.
...
## Recent commits
- 938636c chore: sync PROJECT_STATUS.md [skip ci] (37 seconds ago)
- edf92d6 Fix stale test: DELETE /api/scheduler/:id now requires x-admin-key (56 seconds ago)
