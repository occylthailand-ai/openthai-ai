...
Generated: 2026-07-18T00:14:35.065Z · branch `claude/daily-reporter-improvements-8vc9ct` (424 commit(s) ahead of main)

> Paste this whole file at the start of a Claude / Gemini / Grok conversation about this project
> so all three start from the same facts, pulled directly from the repo — not from memory.

## What this project actually is (read this before anything else)
- Git history: 507 commits, earliest 2026-06-22 — this is the entire real history, there is no earlier "locked" architecture beyond what's in this repo.
...
- f43cafc fix(affiliate-ui): show real data in the sales-history table (was blank columns) (6 hours ago)
