...
Generated: 2026-07-04T23:21:11.494Z · branch `claude/daily-reporter-improvements-8vc9ct` (63 commit(s) ahead of main)

> Paste this whole file at the start of a Claude / Gemini / Grok conversation about this project
> so all three start from the same facts, pulled directly from the repo — not from memory.

## What this project actually is (read this before anything else)
- Git history: 273 commits, earliest 2026-04-02 — this is the entire real history, there is no earlier "locked" architecture beyond what's in this repo.
...
## Recent commits
- df54dbc Fix contrast on every portal's active-language button (run 28 follow-up) (15 seconds ago)
- a1db51e chore: sync PROJECT_STATUS.md [skip ci] (53 minutes ago)
