...
Generated: 2026-07-02T03:21:09.003Z · branch `claude/ai-coalition-protocol-hp3rga` (11 commit(s) ahead of main)

> Paste this whole file at the start of a Claude / Gemini / Grok conversation about this project
> so all three start from the same facts, pulled directly from the repo — not from memory.

## What this project actually is (read this before anything else)
- Git history: 61 commits, earliest 2026-06-16 — this is the entire real history, there is no earlier "locked" architecture beyond what's in this repo.
...
## Recent commits
- 203e284 Add core-philosophy memory pack: JSON/YAML, integration guide, skill prompt, loaders (5 seconds ago)
...
- 161365b chore: regenerate PROJECT_STATUS.md after rebase (14 hours ago)
- 939686d Make the dispute system fairer to both parties (14 hours ago)
- 35c5f57 chore: sync PROJECT_STATUS.md [skip ci] (14 hours ago)
