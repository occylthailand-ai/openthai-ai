...
Generated: 2026-09-22T18:33:49.284Z · branch `claude/digital-yuan-openthaiai-compare-qt5dhn` (60 commit(s) ahead of main)

> Paste this whole file at the start of a Claude / Gemini / Grok conversation about this project
> so all three start from the same facts, pulled directly from the repo — not from memory.

## What this project actually is (read this before anything else)
- Git history: 363 commits, earliest 2026-04-02 — this is the entire real history, there is no earlier "locked" architecture beyond what's in this repo.
...
## Recent commits
- 56ac128 merge: sync with main — keep OpenThaiAi naming, add consent.js import (22 seconds ago)
- 914b300 chore: sync PROJECT_STATUS.md [skip ci] (3 minutes ago)
- 3505c55 chore: sync PROJECT_STATUS.md [skip ci] (65 minutes ago)
...
- 9cba54c chore: sync PROJECT_STATUS.md [skip ci] (3 hours ago)
- 72abf73 feat(limits): centralize every limit into backend/config/limits.js + CLI tool (3 hours ago)
