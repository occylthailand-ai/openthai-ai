...
export const ROUTES = [
  ...
  { path: '/ai-skills', title: 'เครื่องมือ AI เพื่อการค้า', desc: 'รวมเครื่องมือ AI ไทยแท้กว่า 35 ทักษะ ครบทั้งคอนเทนต์ การขาย SEO บริการลูกค้า ตั้งราคา ไลฟ์ขายของ และอีกมาก — ใช้ได้ 3 ภาษา (ไทย/อังกฤษ/จีน) ดูรายการทั้งหมดก่อนสมัคร' },
  { path: '/faq', title: 'คำถามที่พบบ่อย', desc: 'ทุกอย่างที่อยากรู้เกี่ยวกับ OpenThaiAi — วิธีใช้งาน ความปลอดภัยของข้อมูล (PDPA/consent) การชำระเงินพร้อมเพย์ ติดตามคำสั่งซื้อ ข้อพิพาท/escrow การสมัครผู้ผลิต และค่าคอม affiliate ตอบตรงไปตรงมา' },
