...
const translations = {
  th: {
    ...
    'hero.sub2': 'OpenThaiAi สร้างครบเซ็ตพร้อมโพสต์ทันที ภาษาไทยธรรมชาติ',
    ...
    // demo preview
    'demo.title': 'OpenThaiAi Generator — ผ้าไหมอุบล',
    ...
    'demo.hashtags': ['#ผ้าไหม', '#OTOP', '#สินค้าไทย', '#ของดีบ้านเรา', '#TikTokShop', '#ภูมิปัญญาไทย', '#OpenThaiAi'],
    // how it works
    ...
    'features.title': 'ทำไมต้อง OpenThaiAi?',
    'features': [
    ...
    'mk.join.sub': 'สังกัด OpenThaiAi ฟรี — ให้ครีเอเตอร์กว่า 1,200 คนช่วยสร้างคอนเทนต์ + ดันยอดขายสินค้าคุณ จ่ายค่าคอมเฉพาะเมื่อขายได้',
    ...
    'mk.store.sub': 'สินค้าอย่างเป็นทางการจาก OpenThaiAi',
    ...
    'footer.copyright': '© 2026 OpenThaiAi — สงวนลิขสิทธิ์',
  ...
  en: {
    ...
    'hero.sub2': 'OpenThaiAi builds the whole set ready to post — in natural Thai',
    ...
    'demo.title': 'OpenThaiAi Generator — Ubon silk',
    'demo.hook.label': '🎣 Hook',
    ...
    'demo.hashtags.label': '#️⃣ Hashtags',
    'demo.hashtags': ['#ThaiSilk', '#OTOP', '#ThaiProducts', '#LocalGems', '#TikTokShop', '#ThaiCraft', '#OpenThaiAi'],
    ...
    'mk.join.sub': 'Join OpenThaiAi free — 1,200+ creators make content & drive sales for your products. Pay commission only when you sell.',
    ...
    'mk.store.title': 'Openthai Store',
    'mk.store.sub': 'Official products from OpenThaiAi',
    ...
    'footer.copyright': '© 2026 OpenThaiAi — All rights reserved',
    'footer.made': '🇹🇭 Made in Thailand · Powered by Gemini AI',
  },
  ...
  zh: {
    ...
    'hero.sub2': 'OpenThaiAi 一键生成整套内容，立即发布 — 自然地道泰语',
    ...
    'demo.title': 'OpenThaiAi 生成器 — 乌汶丝绸',
    ...
    'demo.hashtags': ['#泰国丝绸', '#OTOP', '#泰国好物', '#家乡好货', '#TikTokShop', '#泰国工艺', '#OpenThaiAi'],
    'how.badge': '使用方法',
    'how.title': '4 步生成内容',
    'steps': [
    ...
    'features.badge': '功能',
    'features.title': '为什么选 OpenThaiAi？',
    'features': [
    ...
    'mk.join.sub': '免费入驻 OpenThaiAi — 1,200+ 创作者帮你做内容、冲销量，成交才付佣金。',
    'mk.join.vp1': '📣 创作者帮你推广',
    'mk.join.vp2': '🤝 成交才付佣金',
    ...
    'footer.copyright': '© 2026 OpenThaiAi — 版权所有',
