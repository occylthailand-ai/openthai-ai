...
const translations = {
  th: {
    ...
    'pp.svc.title': 'บริการจับคู่ธุรกิจโดยทีมงาน (฿15,000-25,000/องค์กร)',
    'pp.svc.desc': 'ทีมงานคัดคู่ค้าและทำการตลาดให้ ไม่ใช่แค่ระบบ — นัดคุยฟรีก่อนตัดสินใจ',
    'pp.svc.cta': '🤝 ดูแพ็กเกจบริการ →',
  ...
  en: {
    ...
    'pp.svc.title': 'Hands-on business matching service (฿15,000-25,000/org)',
    'pp.svc.desc': 'Our team curates partners and marketing for you — free consultation first',
    'pp.svc.cta': '🤝 View service packages →',
  ...
  zh: {
    ...
    'pp.faq.title': '❓ 常见问题',
    'pp.svc.title': '团队人工商业配对服务（฿15,000-25,000/机构）',
    'pp.svc.desc': '由团队为您筛选合作伙伴并提供营销支持 — 先免费咨询',
    'pp.svc.cta': '🤝 查看服务套餐 →',
