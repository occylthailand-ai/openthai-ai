...
function authHeaders() {
  ...
  // x-device-id ผูกกับเครดิตโบนัส (spin/streak) ให้ใช้ generate เกินโควต้าฟรีได้
  return { 'Content-Type': 'application/json', 'x-device-id': getDeviceId(), ...(email ? { 'x-user-email': email } : {}) };
}
