      ...
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '48px 5% 0' }}>
        ...
        <Section title="6. สิทธิของเจ้าของข้อมูล (PDPA)">
          ...
          <p style={{ marginTop: 16, fontSize: 13 }}>
            ติดต่อขอใช้สิทธิได้ที่ <a href="mailto:privacy@openthai-ai.com" style={{ color: '#6366f1' }}>privacy@openthai-ai.com</a> — เราจะตอบกลับภายใน 30 วัน
          </p>
        </Section>
        ...
        <Section title="8. ติดต่อ DPO (Data Protection Officer)">
          <div style={{ background: 'rgba(255,255,255,0.03)', borderRadius: 12, padding: '20px 24px' }}>
            ...
            <div style={{ fontSize: 13, lineHeight: 2 }}>
              📧 Email: <a href="mailto:privacy@openthai-ai.com" style={{ color: '#6366f1' }}>privacy@openthai-ai.com</a><br />
