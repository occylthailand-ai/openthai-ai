...
const QUICK_ACTIONS = [
  ...
  { icon: '🧰', label: 'Meta-Toolsmith v1.2', desc: 'Forge 13 artifacts · Healer · Quorum · OCI validator · Gates แบบ authoritative', route: '/meta-toolsmith', color: '#0ea5e9', hot: true },
  ...
  { icon: '🤖', label: 'AI ที่ปรึกษา (Chat)', desc: 'แชทถามธุรกิจอะไรก็ได้ · ตอบสดทีละคำ · จำบทสนทนาข้ามอุปกรณ์', route: '/assistant', color: '#8b5cf6', hot: true },
