        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 24, justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 28 }}>
          ...
          <div style={{ display: 'flex', gap: 48, flexWrap: 'wrap' }}>
            <div>
              ...
              {[[t('footer.link.generator'), '/ai-generator'], [t('footer.link.pricing'), '/pricing'], [t('footer.link.catalog'), '/catalog'], [t('footer.link.find'), '/find-producers'], [t('footer.link.affiliate'), '/affiliate'], [t('footer.link.producer'), '/join']].map(([l, r]) => (
