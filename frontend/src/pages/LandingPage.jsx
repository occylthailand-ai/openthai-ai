...
const PLAN_META = [
  ...
  { id: 'pro', price: '20', color: '#6366f1', recommended: true },
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 24, justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 28 }}>
          ...
          <div style={{ display: 'flex', gap: 48, flexWrap: 'wrap' }}>
            <div>
              ...
              {[[t('footer.link.generator'), '/ai-generator'], [t('footer.link.pricing'), '/pricing'], [t('mk.nav.store'), '/store'], [t('footer.link.catalog'), '/catalog'], [t('footer.link.find'), '/find-producers'], [t('mk.nav.deliver'), '/delivery'], [t('mk.nav.carrier'), '/carrier'], [t('footer.link.affiliate'), '/affiliate'], [t('footer.link.producer'), '/join']].map(([l, r]) => (
