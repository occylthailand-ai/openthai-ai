        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 24, justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 28 }}>
          ...
          <div style={{ display: 'flex', gap: 48, flexWrap: 'wrap' }}>
            ...
            <div>
              ...
              {[[t('footer.link.showcase'), '/showcase'], [t('footer.link.seasonal'), '/seasonal'], ['เกี่ยวกับเรา', '/about'], [t('footer.link.privacy'), '/privacy'], [t('footer.link.terms'), '/terms'], [t('footer.link.contact'), 'mailto:support@openthai.ai']].map(([l, r]) => (
                r.startsWith('mailto')
