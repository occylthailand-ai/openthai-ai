...
export default function IntlOrgPortalPage() {
  ...
  const submit = async e => {
    e.preventDefault();
    setErr(''); setBusy(true);
    const r = await submitLead({ ...form, type:'intl-org', lang, consent });
    setBusy(false);
    ...
    <div style={{ minHeight:'100vh', background:'#0a0a0f', color:'#fff', fontFamily:'system-ui,sans-serif' }}>
      ...
      <div style={{ maxWidth:960, margin:'0 auto', padding:'48px 32px' }}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1.4fr', gap:32 }}>
          <div>
            <h3 style={{ color:'#8b5cf6', marginBottom:20 }}>{t.svcTitle}</h3>
