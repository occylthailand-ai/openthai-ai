...
const T = {
  th: {
    ...
    sub: 'OpenThaiAi แบ่งปันกำไรให้มูลนิธิช่วยเหลือผู้ยากไร้เมื่อกำไรรวมเกิน 10 ล้านบาท',
    badge: '⚡ เปิดใช้งานอัตโนมัติเมื่อกำไร > 10,000,000 ฿',
    how: ['OpenThaiAi สร้างกำไรรวมเกิน 10 ล้านบาท','ระบบโอนเงินอัตโนมัติ 5% ของกำไรส่วนเกินไปยังกองทุนมูลนิธิ','มูลนิธิที่ลงทะเบียนไว้จะได้รับการจัดสรรตามสัดส่วน','โปร่งใส ตรวจสอบได้ผ่าน Dashboard'],
  ...
  en: {
    ...
    sub: 'OpenThaiAi shares profits with poverty-relief foundations when cumulative profit exceeds 10M THB',
    badge: '⚡ Auto-activated when profit > 10,000,000 THB',
    how: ['OpenThaiAi cumulative profit exceeds 10M THB','System auto-transfers 5% of excess profit to foundation fund','Registered foundations receive proportional allocation','Fully transparent — auditable via Dashboard'],
  ...
  zh: {
    title: '基金会/NGO门户',
    sub: '当OpenThaiAi累计利润超过1000万泰铢时，将向扶贫基金会分享利润',
    badge: '⚡ 利润超过10,000,000泰铢时自动激活',
    how: ['OpenThaiAi累计利润超过1000万泰铢','系统自动将超额利润的5%转入基金会基金','注册的基金会按比例获得分配','完全透明 — 可通过Dashboard审计'],
