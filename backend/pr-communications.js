    ...
    getPressReleases: () => load('pr_releases.json', [
      {
        ...
        content: [
          'กรุงเทพฯ — Openthai.ai ประกาศเปิดตัวแพลตฟอร์ม AI สร้างคอนเทนต์ TikTok และโซเชียลมีเดียที่ออกแบบมาเพื่อผู้ประกอบการ SME และผู้ค้า OTOP ของไทยโดยเฉพาะ มุ่งปิดช่องว่างที่คนไทยกว่า 80% ใช้ AI แล้ว แต่มีเพียงราว 16% ที่ใช้ได้เต็มประสิทธิภาพ',
          '',
          'หัวใจของแพลตฟอร์มคือการสร้างสคริปต์ TikTok 30 วินาที (Hook 3วิ + Story 20วิ + CTA 7วิ) พร้อมแคปชั่นและแฮชแท็ก 10 รายการ เลือกได้จาก 5 รูปแบบ Hook สิ่งที่ต่างจากทุกเจ้าคือ AI Critic ที่ให้คะแนนและส่งเฉพาะงาน ≥ 7/10 และ Learning Layer ที่อธิบายว่าทำไม Hook นั้นถึงเวิร์ก เพื่อให้ผู้ค้าเก่งขึ้นในระยะยาว',
          '',
          '"เครื่องมือ AI ส่วนใหญ่สร้างคอนเทนต์ให้เสร็จแล้วจบ แต่ผู้ประกอบการไทยต้องการขายของได้" คุณซื่อใจ แซ่หย่าง ประธานกรรมการและซีอีโอ Openthai.ai กล่าว',
          '',
          'แพลตฟอร์มยังรวมระบบพาณิชย์ครบวงจร ทั้งสต๊อก การรับชำระผ่าน PromptPay/บัตร ระบบ affiliate และเครดิต รองรับสินค้า 300+ รายการจาก 35 ประเทศ และ 3 ภาษา (ไทย/อังกฤษ/จีน) ราคาเริ่มต้นฟรี (฿0), Pro ฿149/เดือน และ Business ฿299/เดือน บริษัทตั้งเป้าเข้าจดทะเบียน MAI ภายในปี 2570',
          '',
          'เริ่มใช้งานได้ที่ openthai-ai.vercel.app',
        ].join('\n'),
        views: 0, media_picked_up: [],
      },
      {
