-- ============================================================
-- OpenThai AI — Supabase Database Schema v2.0
...
-- DROP ก่อนสร้าง (idempotent)
DROP POLICY IF EXISTS "Users can view own profile"           ON public.profiles;
DROP POLICY IF EXISTS "Users can update own profile"         ON public.profiles;
DROP POLICY IF EXISTS "Users can view own content"           ON public.content_history;
DROP POLICY IF EXISTS "Users can insert own content"         ON public.content_history;
DROP POLICY IF EXISTS "Users can view own transactions"      ON public.ota_transactions;
DROP POLICY IF EXISTS "Anyone can view listed NFTs"          ON public.nft_badges;
DROP POLICY IF EXISTS "Users can manage own NFTs"            ON public.nft_badges;
DROP POLICY IF EXISTS "Users can view own subscriptions"     ON public.subscriptions;
DROP POLICY IF EXISTS "Anyone can submit B2G inquiry"        ON public.b2g_inquiries;
DROP POLICY IF EXISTS "Users can view own B2G inquiries"     ON public.b2g_inquiries;
DROP POLICY IF EXISTS "Anyone can submit payment notification" ON public.payment_notifications;
